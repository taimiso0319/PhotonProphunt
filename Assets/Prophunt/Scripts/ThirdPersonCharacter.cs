...
namespace Prophunt.SDUnitychan.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		public void HandleGroundedMovement(bool crouch, bool jump)
		{
			...
			if (jump && !crouch && !m_Animator.GetCurrentAnimatorStateInfo(0).IsName("Jumping@loop"))
			{
				// jump!
				...
				//m_Capsule.center = m_CapsuleCenter * 2.0f;
				//m_Capsule.height = m_CapsuleHeight / 2.0f;
			}
			//if(m_Animator.GetCurrentAnimatorStateInfo(0).fullPathHash != jumpState && jump)
